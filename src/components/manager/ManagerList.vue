      ...
      <template v-slot:item="{ item }">
        <tr>
          ...
          <td class="manager-list__cell barter">
            <span class="card-type card-type_company text-hidden"><translate>Бартер</translate></span>
          ...
          <td class="manager-list__cell action">
            <UiDropdown>
              ...
              <a @click.prevent="duplicateCampaign(item.id)" href="#"
                class="dropdown__link dropdown__link_copy">
                <translate>Дублировать</translate>
              </a>
              <a @click.prevent="payCampaign(item.id)" href="#"
                class="dropdown__link dropdown__link_pay">
                <translate>Оплата и запуск</translate>
              </a>
              <a @click.prevent="deleteCampaign(item.id)" href="#"
    ...
    <UiCard v-for="campaign in campaignList" :key="campaign.id" class="ui-item-card">
      ...
      <div v-show="selectedItem === campaign.id" class="ui-item-card__inner">
        <div class="ui-item-card__item">
          <span class="ui-item-card__item-title"><translate>Охват</translate></span>
          {{ campaign.offers_reach }}
        </div>
        <div class="ui-item-card__item">
          <span class="ui-item-card__item-title"><translate>CTR</translate></span>
          {{ campaign.offers_ctr }}%
        </div>
        <div class="ui-item-card__item">
        ...
        <div class="ui-item-card__item">
          <span class="ui-item-card__item-title"><translate>Бюджет</translate></span>
          $&nbsp;{{ campaign.budget }}
        </div>
        <div class="ui-item-card__item">
          <span class="ui-item-card__item-title"><translate>Переходы</translate></span>
        ...
        <div class="ui-item-card__item wide">
          <UiDropdown>
            ...
            <a @click.prevent="duplicateCampaign(campaign.id)" href="#"
                class="dropdown__link dropdown__link_copy">
                <translate>Дублировать</translate>
            </a>
            <a @click.prevent="payCampaign(campaign.id)" href="#"
                class="dropdown__link dropdown__link_pay">
                <translate>Оплата и запуск</translate>
            </a>
            <a @click.prevent="deleteCampaign(campaign.id)" href="#"
                class="dropdown__link dropdown__link_delete">
                <translate>Удалить</translate>
            </a>
          </UiDropdown>
