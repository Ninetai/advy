<template>
    <div>
        ...
        <div class="iframeDetails">
            <div v-for="(url,index) in embedUrl" :key="index">
                    ...
                    <div style="padding:16px;"> <a :href="url"
                        ...
                        <p
                            ...
                            <a :href="url"
                                ...
                                target="_blank">A post shared by Instagram (@instagram)</a>
                        </p>
                    </div>
                </blockquote>
            </div>
...
export default {
    ...
    methods: {
        async onSubmit() {
            ...
            var tempEmbedUrl = this.url;
            if (urlParts.length >= 2) {
                var urlBase = urlParts.shift();
                //tempEmbedUrl = urlBase += "embed"
                this.embedUrl.push(tempEmbedUrl);
